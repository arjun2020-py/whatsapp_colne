...
class ChatBabble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Align(
        ...
        alignment:bable.isSend!? Alignment.centerRight:Alignment.centerLeft, // align chat in whatsapp using single line function
          ...
          child: Card(
            ...
            child: Stack(
              children: [
                 Padding(
                  padding:
                     const  EdgeInsets.only(left: 10, top: 7, right: 58, bottom: 10),
